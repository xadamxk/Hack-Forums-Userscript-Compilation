// ==UserScript==
// @name           Hf Mentor Username Colors
...
html = html.replace( /-BoodyE-/g, '<span style="text-shadow: 0px 0px 16px #FFFFFF"><font color="#E4FF99"><b>-BoodyE-</b></font></span>' );
html = html.replace( /adampelletgun/g, '<span style="text-shadow: 0px 0px 16px #FFFFFF"><font color="#E4FF99"><b>adampelletgun</b></font></span>' );
